/*
Aquest codi forma part del treball final de grau "ESTUDI I IMPLEMENTACIÓ 
DE SISTEMES AUXILIARS EN UNA BANCADA DE PROVA DE MOTORS COET" realitzat
per l'alumne Joan Costa Garcia. La bancada es troba al laboratori
d'aeronàutica de l'Escola Superior d'Enginyeries Industrial, Aeroespacial,
i Audiovisual de Terrassa (ESEIAAT).

El codi permet obtenir les lectures de la cèl·lula de càrrega a partir d'un
arduino MEGA, un ADC AD7606 i un amplificador diferencial.

Aquest codi pot ser descargat al següent URL:
https://github.com/jcostagarcia/TFG-BANCADA-ESEIAAT
*/
...
void ISR_ ()  {
  ...
  /*
   L'ADC permet llegir de forma paral·lela fins a 8 entrades analògiques. En el
   cas que es vulguin utilitzar, s'ha de copiar i enganxar a continuació les 
   anteriors 5 línies de codi dins de la funció ISR_ tantes vegades com entrades
   analògiques es requereixin.   
   */
